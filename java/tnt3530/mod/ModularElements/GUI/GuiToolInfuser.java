...
public class GuiToolInfuser extends GuiContainer{
	private static final ResourceLocation furnaceGuiTextures = new ResourceLocation(Constants.MODID + ":" + "textures/client/gui/guitoolinfuser.png");
	private TileEntityToolInfuser tileFurnace;
	
	//private GuiTextField text;
	//private boolean set = false;
	
	public GuiToolInfuser(InventoryPlayer invPlayer, TileEntityToolInfuser tile) {
		super(new ContainerToolInfuser(invPlayer, tile));
	...
	*/
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2){
		...
		String string = this.tileFurnace.hasCustomInventoryName() ? this.tileFurnace.getInventoryName() : I18n.format(Constants.MODID + "_" + "blockToolInfuserGuiName", new Object[0]);
		
		this.fontRendererObj.drawString(string, this.xSize / 2 - this.fontRendererObj.getStringWidth(string) + 58, -17, 4210752);
