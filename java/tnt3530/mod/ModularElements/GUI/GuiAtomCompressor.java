...
public class GuiAtomCompressor extends GuiContainer{
	private static final ResourceLocation furnaceGuiTextures = new ResourceLocation(Constants.MODID + ":" + "textures/client/gui/guiatomcompressor.png");
	private TileEntityAtomCompressor tileFurnace;
	
	//private GuiTextField text;
	//private boolean set = false;
	
	public GuiAtomCompressor(InventoryPlayer invPlayer, TileEntityAtomCompressor tile) {
		super(new ContainerAtomCompressor(invPlayer, tile));
	...
	*/
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2){
		...
		String string = this.tileFurnace.hasCustomInventoryName() ? this.tileFurnace.getInventoryName() : I18n.format(Constants.MODID + "_" + "blockAtomCompressorGuiName", new Object[0]);
