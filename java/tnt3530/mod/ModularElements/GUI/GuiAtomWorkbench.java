...
public class GuiAtomWorkbench extends GuiContainer{
	...
	*/
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2){
		...
		this.fontRendererObj.drawString("Element Info-", this.xSize / 2 + basicX, basic - change -1, 4210752);
		//this.fontRendererObj.drawString("State: " + state, this.xSize / 2 + basicX, basic, 4210752);
		this.fontRendererObj.drawString("Stability: " + this.tileFurnace.elementInformation[5], this.xSize / 2 + basicX, basic + (0 * change), 4210752);
		this.fontRendererObj.drawString("Valence : " + this.tileFurnace.elementInformation[6], this.xSize / 2 + basicX, basic + (1 * change), 4210752);
		this.fontRendererObj.drawString("Charge: " + this.tileFurnace.elementInformation[7], this.xSize / 2 + basicX, basic + (2 * change), 4210752);
		this.fontRendererObj.drawString("Weight: " + this.tileFurnace.elementInformation[8], this.xSize / 2 + basicX, basic + (3 * change), 4210752);
		this.fontRendererObj.drawString("Hardness: " + this.tileFurnace.elementInformation[9], this.xSize / 2 + basicX, basic + (4 * change), 4210752);
		this.fontRendererObj.drawString("Brittleness: " + this.tileFurnace.elementInformation[10], this.xSize / 2 + basicX, basic + (5 * change), 4210752);
		this.fontRendererObj.drawString("Conductivity: " + this.tileFurnace.elementInformation[11], this.xSize / 2 + basicX, basic + (6 * change), 4210752);
		this.fontRendererObj.drawString("Flamibility: " + this.tileFurnace.elementInformation[12], this.xSize / 2 + basicX, basic + (7 * change), 4210752);
		this.fontRendererObj.drawString("Atomic Mass: " + mass, this.xSize / 2 + basicX, basic + (9 * change), 4210752);
